...
# macOS (Apple Silicon)
wget https://go.dev/dl/go1.26.4.darwin-arm64.tar.gz
sudo tar -C /usr/local -xzf go1.26.4.darwin-arm64.tar.gz
rm go1.26.4.darwin-arm64.tar.gz
