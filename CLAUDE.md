...
- **Go version:** 1.26 series — `go.mod` declares `go 1.26.4`; CI pin is `go-version: "1.26"` (auto-resolves to latest 1.26.x patch). Release builds since v1.0.5 use 1.26.4+.
